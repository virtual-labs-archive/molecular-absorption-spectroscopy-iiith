...
RUN mkdir /molecular-absorption-spectroscopy-iiith

COPY src/ /molecular-absorption-spectroscopy-iiith/src

WORKDIR ./molecular-absorption-spectroscopy-iiith/src
